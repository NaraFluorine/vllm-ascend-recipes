          ...
          <div className="space-y-8">
            ...
            {hasAccuracy && (
              <div>
                ...
                <div
                  className="prose"
                  dangerouslySetInnerHTML={{ __html: renderContent(accuracy) }}
                />
              </div>
            )}
            {!!evaluationAccuracy && (
            ...
            {references.map((ref) => (
              <li key={ref.url}>
                <a
                  ...
                  className="inline-flex items-center gap-2 text-sm text-accent-400 hover:text-accent-300 transition-colors font-mono"
                >
